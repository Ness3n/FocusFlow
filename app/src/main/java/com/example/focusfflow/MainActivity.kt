...
import com.example.focusfflow.ui.screens.settings.account.AccountSettingsScreen
import com.example.focusfflow.ui.screens.settings.notifications.NotificationSettingsScreen
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // IMPORTANTE: Inicializar Retrofit con el contexto de la aplicación
